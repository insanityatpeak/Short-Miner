...
/* Hero */
.sm-hero { margin-bottom: var(--space-4xl); }
.sm-hero-badge {
...
div[class*="st-key-callout-0"] .sm-callout-time { color: var(--color-link-deep); }
div[class*="st-key-callout-1"] .sm-callout-time { color: var(--color-warning-deep); }
.sm-callout-meta {
  font-size: 14px;
  line-height: 20px;
  color: var(--color-body);
